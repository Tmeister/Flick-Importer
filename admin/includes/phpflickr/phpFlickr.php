...
if ( !class_exists('phpFlickr') ) {
	...
	class phpFlickr {
		...
		*/
		...
		function photosets_getList ($user_id = NULL, $page = NULL, $per_page = NULL) {
			/* http://www.flickr.com/services/api/flickr.photosets.getList.html */
			$this->request("flickr.photosets.getList", array("user_id" => $user_id, "page" => $page, "per_page" => $per_page));
